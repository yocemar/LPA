...
<div id="content">
  ...
  <form name="frmSearchStock" method="post" id="frmSearchStock" action="<?PHP echo $_SERVER['PHP_SELF']; ?>">
    <div class="displayPane">
      ...
      <div>
        <input name="txtSearch" id="txtSearch" placeholder="Search Stock" style="width: calc(100% - 115px)"
  ...
  <?PHP
      if(/*$action == "listStock"*/true) {
    ?>
  <div>
    <table class="table" style="width: calc(100% - 15px);border: #cccccc solid 1px">
      <thead class="table-dark">
        <tr style="background: #eeeeee">
          <td style="width: 100px;border-left: #cccccc solid 1px"><b>Stock Code</b></td>
